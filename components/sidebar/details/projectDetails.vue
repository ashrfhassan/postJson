<template>
  <div id="project-details" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<a class="waves-effect waves-light pink lighten-1 white-btn pulse btn">Generate Document</a>
  </div>
    <div class="col-md-6 col-sm-6 text-center">
