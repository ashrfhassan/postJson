...
<app-urlsection @changRequestType="changRequestType"></app-urlsection>
    ...
    <li class="tab col" :class="[swaper.isFullROW ? 's12' : 's6']"><a id="headers-tab" :class="{'active-tab':swaper.isActiveHeaders}" @click="toggleHeaderBody" href="#" data-toggle="headers">Headers</a></li>
    <li class="tab col" :class="[swaper.isFullROW ? 'd-none' : 's6']"><a id="body-tab" :class="{'active-tab':swaper.isActiveBody}" @click="toggleHeaderBody" href="#" data-toggle="body">Body</a></li>
  </ul>
           </div>
       </div>
       <keep-alive>
...
import Headers from "./requestHeaders.vue";
import Body from "./requestBody.vue";
