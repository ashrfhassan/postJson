<template>
    <div id="project-details" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
...
<script>
    export default {
        ...
        methods: {
            closeModal: function () {
                document.getElementById("project-details").modal("hide");
            }
        }
    };
</script>